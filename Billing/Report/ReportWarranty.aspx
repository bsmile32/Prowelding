<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ReportWarranty.aspx.cs" Inherits="Billing.Report.ReportWarranty" %>
            ...
            <div class="panel panel-info panel-info-dark" style="min-height: 370px;">
                <div class="panel-heading panel-heading-dark text-left">
                    <h3 class="panel-title">
                        <strong>
                            <asp:Label ID="lblHeader" runat="server" Text="">ใบรับประกัน</asp:Label>
                        </strong>
                    </h3>
                </div>
                <div class="panel-body text-center" style="margin-top: 5px;">
                    <div style="padding: 0px 15px 15px 15px;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-4 rowData">
                                <asp:TextBox ID="txtSaleNo" runat="server" class="form-control"></asp:TextBox>
                            </div>
                            <div class="col-xs-2 headerData">Serial No.</div>
                            <div class="col-xs-4 rowData">  
                            ...
                            <div class="col-xs-12">
                                <asp:GridView ID="gv" runat="server" Width="100%" AutoGenerateColumns="False">
                                    <Columns>       
                                        <asp:TemplateField HeaderText="Print">
                                            <ItemTemplate>
                                                ...
                                                <asp:HiddenField ID="hddID" runat="server" 
                                                    Value='<%# DataBinder.Eval(Container.DataItem, "DetailID").ToString()%>' />
                                            </ItemTemplate>
                                        ...
                                        <asp:BoundField HeaderText="วันที่ซื้อ" DataField="WarrantyDateStr">
                                            <HeaderStyle CssClass="text-center width10" />
                                            <ItemStyle CssClass="text-left"/>
                                        </asp:BoundField>                                                            
                                    </Columns>
