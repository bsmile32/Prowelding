<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="MasterUnit.aspx.cs" Inherits="Billing.Setup.MasterUnit" %>
            ...
            <div class="panel panel-info" style="min-height: 500px;">
                <div class="panel-heading panel-heading-dark text-left">
                    <h3 class="panel-title">
                        <strong>
                            <asp:Label ID="lblHeader" runat="server" Text="">Search Unit</asp:Label>
                        </strong>
                    </h3>
                </div>
                <div class="panel-body text-center" style="margin-top: 5px;">
                    <div style="padding: 0px 15px 15px 15px;">
                        <div class="row">
                            ...
                            <div class="col-xs-2 headerData"><b>หน่วย :</b></div>
                            <div class="col-xs-4 rowData">
                            ...
                            <div class="col-xs-12">
                                ...
                                <asp:GridView ID="gv" runat="server" Width="40%" AutoGenerateColumns="False">
                                    <Columns>
                                        ...
                                        <asp:BoundField HeaderText="รหัส" DataField="UnitCode">
                                        ...
                                        <asp:TemplateField HeaderText="Tools">
                                            <ItemTemplate>
                                                ...
                                                <asp:ImageButton ID="imgbtnEdit" runat="server" Height="20px" Width="20px" ImageUrl="~/img/icon/b_edit.png" 
                                                    CommandArgument='<%# DataBinder.Eval(Container.DataItem, "UnitID").ToString()%>'
    ...
    <asp:Panel ID="Panel1" Height="350px" Width="500px" runat="server" Style="display: none;">
        ...
        <div class="panel panel-info-dark width98" style="min-height: 280px;">
            <div class="panel-heading text-left">
                <h3 class="panel-title">
                    <asp:Label ID="lbl_modal_view" runat="server" CssClass="modalHeader" Text="Manage Unit"></asp:Label>
                </h3>
            </div>
            <div class="row" style="margin-top: 20px;">
                ...
                <div class="col-md-7 rowData">
                    <asp:TextBox ID="txtMUnitCode" runat="server"></asp:TextBox>
                </div>
                <div class="col-md-1"></div>
            </div>
            <div class="row">
                <div class="col-md-1"></div>
                <div class="col-md-3 headerData"><b>หน่วย :</b></div>
                <div class="col-md-7 rowData">
                    <asp:TextBox ID="txtMUnitName" runat="server"></asp:TextBox>
