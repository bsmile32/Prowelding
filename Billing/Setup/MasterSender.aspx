<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="MasterSender.aspx.cs" Inherits="Billing.Setup.MasterSender" %>
            ...
            <div class="panel panel-info" style="min-height: 500px;">
                <div class="panel-heading panel-heading-dark text-left">
                    <h3 class="panel-title">
                        <strong>
                            <asp:Label ID="lblHeader" runat="server" Text="">Search Sender</asp:Label>
                        </strong>
                    </h3>
                </div>
                <div class="panel-body text-center" style="margin-top: 5px;">
                    <div style="padding: 0px 15px 15px 15px;">
                        <div class="row">
                            ...
                            <div class="col-xs-2 headerData"><b>เบอร์ :</b></div>
                            <div class="col-xs-4 rowData">
                        ...
                        <div class="row" style="margin-top: 15px; max-height:350px; overflow:auto;">
                            <div class="col-xs-12">
                                ...
                                <asp:GridView ID="gv" runat="server" Width="100%" AutoGenerateColumns="False">
                                    <Columns>
                                        <asp:BoundField HeaderText="ชื่อผู้ส่ง" DataField="SenderName">
                                            <HeaderStyle CssClass="text-center width50 headerData" />
                                            <ItemStyle CssClass="text-left rowData" />
                                        </asp:BoundField>
                                        <asp:BoundField HeaderText="เบอร์" DataField="Tel">
                                        ...
                                        <asp:TemplateField HeaderText="Tools">
                                            <ItemTemplate>
                                                ...
                                                <asp:ImageButton ID="imgbtnEdit" runat="server" Height="20px" Width="20px" ImageUrl="~/img/icon/b_edit.png" 
                                                    CommandArgument='<%# DataBinder.Eval(Container.DataItem, "SenderID").ToString()%>'
    ...
    <asp:Panel ID="Panel1" Height="350px" Width="800px" runat="server" Style="display: none;">
        ...
        <div class="panel panel-info-dark width98" style="min-height: 280px;">
            <div class="panel-heading text-left">
                <h3 class="panel-title">
                    <asp:Label ID="lbl_modal_view" runat="server" CssClass="modalHeader" Text="Manage Sender"></asp:Label>
                </h3>
            </div>
            <div class="row" style="margin-top: 20px;">
                <div class="col-md-1"></div>
                <div class="col-md-2 headerData"><b>ชื่อผู้ส่ง :</b></div>
                <div class="col-md-8 rowData">
                    <asp:TextBox ID="txtMSenderName" runat="server" Width="80%"></asp:TextBox>
            ...
            <div class="row">
                <div class="col-md-1"></div>
                <div class="col-md-2 headerData"><b>เบอร์ :</b></div>
                <div class="col-md-8 rowData">
                    <asp:TextBox ID="txtMTel" runat="server" Width="80%"></asp:TextBox>
                </div>
                <div class="col-md-1"></div>
            </div>
            <div class="row" style="margin-top: 15px;">
